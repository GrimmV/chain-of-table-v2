few_shot_individual_operation = {
    "plan_add_column_demo": """If the table does not have the needed column to tell whether the statement is True or False, we use add_column() to add a new column for it. For example,
    /*
    ...
    */
    ...
    Function: add_column(country of athlete)
    ...
    "plan_select_column_demo": """If the table only needs a few columns to tell whether the statement is True or False, we use select_column() to select these columns for it. For example,
    /*
    ...
    */
    ...
    Function: select_column(county, population)
    ...
    "plan_select_row_demo": """If the table only needs a few rows to tell whether the statement is True or False, we use select_row() to select these rows for it. For example,
    /*
    ...
    */
    ...
    Function: select_row(row 1, row 4, row 5)
    ...
    "plan_group_column_demo": """If the statement is about items with the same value and the number of these items, we use group_column() to group the items. For example,
    /*
    ...
    */
    ...
    "plan_sort_column_demo": """If the statement is about the order of items in a column, we use sort_column() to sort the items. For example,
    /*
    ...
    */
    ...
    Function: sort_column(position, descending)
